...
#define MM_ERROR_TRANSCODE_CLASS		0x80000d00		/**< Error message for describing transcode error group */
...
#define MM_ERROR_NOT_IMPLEMENTED		(MM_ERROR_CLASS | 0x0a)		/**< Error message for not implemented functions */
